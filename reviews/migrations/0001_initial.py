    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='records.record')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cycle', to='reviews.review')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_next', models.ManyToManyField(blank=True, to='reviews.reviewtype')),
                ('default_reviewer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('prerequisite', models.ManyToManyField(blank=True, to='reviews.reviewtype')),
                ('review_division', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='profiles.division')),
                ('review_fees', models.ManyToManyField(blank=True, related_name='+', to='fees.feetype')),
            ],
            options={
